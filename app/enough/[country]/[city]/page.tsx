...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    ...
    description: `Rough estimate of what's left after rent, bills and commute for a single renter in ${prettyCity}. Check if your salary is enough for ${prettyCity}.`,
    alternates: {
      canonical,
    },
  };
